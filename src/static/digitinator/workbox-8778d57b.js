define("./workbox-8778d57b.js", ["exports"], (function(t) {
    ...
    class a {
        ...
        handleRequest({
            ...
            return c instanceof Promise && this.o && (c = c.catch((n => this.o.handle({
                url: s,
                request: t,
                event: e
            })))), c
        ...
        findMatchingRoute({
            ...
            for (const r of i) {
                ...
                if (a) return i = a, (Array.isArray(a) && 0 === a.length || a.constructor === Object && 0 === Object.keys(a).length || "boolean" == typeof a) && (i = void 0), {
                    route: r,
                    params: i
                }
            }
    ...
    for (const [t, e] of Object.entries(m))
        for (const s of e) s in IDBObjectStore.prototype && (y.prototype[s] = async function(e, ...n) {
    ...
    class v {
        constructor(t) {
            this.R = t, this.h = new y("workbox-expiration", 1, {
                onupgradeneeded: t => this.v(t)
            })
        }
        v(t) {
            const e = t.target.result.createObjectStore(g, {
                keyPath: "id"
            });
    ...
    class q {
        constructor(t, e = {}) {
            this.U = !1, this._ = !1, this.L = e.maxEntries, this.N = e.maxAgeSeconds, this.C = e.matchOptions, this.R = t, this.T = new v(t)
        }
        async expireEntries() {
    ...
    class C {
        constructor(t, e) {
            this.D = {}, Object.assign(this, e), this.event = e.event, this.P = t, this.k = new b, this.K = [], this.O = [...t.plugins], this.M = new Map;
        ...
        cacheMatch(t) {
            return this.waitUntil((async () => {
                ...
                const {
                    cacheName: n,
                    matchOptions: i
                } = this.P, r = await this.getCacheKey(e, "read"), a = x({}, i, {
                    cacheName: n
                });
        ...
        async getCacheKey(t, e) {
            if (!this.D[e]) {
                let s = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) s = N(await t({
                    mode: e,
                    request: s,
                    event: this.event,
                    params: this.params
    ...
    class E {
        ...
        async A(t, e, n) {
            ...
            try {
                if (i = await this.I(e, t), !i || "error" === i.type) throw new s("no-response", {
                    url: e.url
                })
            } catch (s) {
    ...
    class W extends E {
        constructor(t = {}) {
            t.cacheName = f(t.cacheName), super(t), this.B = !1 !== t.fallbackToNetwork, this.plugins.push(M)
        }
        async I(t, e) {
        ...
        async H(t, e) {
            let n;
            if (!this.B) throw new s("missing-precache-entry", {
        ...
        async F(t, e) {
            ...
            let i = Boolean(n);
            if (n && n.status >= 400 && !this.$() && (i = !1), !i) throw new s("bad-precaching-response", {
                url: t.url,
                status: n.status
            });
            return n
    ...
    class A {
        constructor({
            ...
            this.G = new Map, this.V = new Map, this.J = new Map, this.P = new W({
                cacheName: f(t),
                plugins: [...e, new k({
        ...
        precache(t) {
            this.addToCacheList(t), this.X || (self.addEventListener("install", this.install), self.addEventListener("activate", this.activate), this.X = !0)
        }
        addToCacheList(t) {
            const e = [];
            for (const n of t) {
                ...
                if (this.G.has(i) && this.G.get(i) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                    firstEntry: this.G.get(i),
                    secondEntry: t
                });
                if ("string" != typeof n && n.integrity) {
                    if (this.J.has(t) && this.J.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {
                        url: i
                    });
        ...
        createHandlerBoundToURL(t) {
            ...
            return s => (s.request = new Request(t), s.params = x({
                cacheKey: e
    ...
    t.CacheFirst = class extends E {
        ...
        constructor(t = {}) {
            ...
            }, this.tt = t, this.N = t.maxAgeSeconds, this.et = new Map, t.purgeOnQuotaError && (e = () => this.deleteCacheAndMetadata(), p.add(e))
        }
        Z(t) {
        ...
        constructor(t = {}) {
            super(t), this.plugins.some((t => "cacheWillUpdate" in t)) || this.plugins.unshift(U), this.nt = t.networkTimeoutSeconds || 0
        }
        async I(t, e) {
            const n = [],
                i = [];
            ...
            if (o || (o = await a), !o) throw new s("no-response", {
                url: t.url
            });
            return o
        }
